...
import Tool26Content from "../assets/defaultToolData.json";

const Tool26 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool26Content[25];
