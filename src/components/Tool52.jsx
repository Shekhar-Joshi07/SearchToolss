...
import Tool52Content from "../assets/defaultToolData.json";

const Tool52 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool52Content[51];
