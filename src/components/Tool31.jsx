...
import Tool31Content from "../assets/defaultToolData.json";

const Tool31 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool31Content[30];
