...
import Tool49Content from "../assets/defaultToolData.json";

const Tool49 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool49Content[48];
