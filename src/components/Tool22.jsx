...
import Tool22Content from "../assets/defaultToolData.json";

const Tool22 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool22Content[21];
