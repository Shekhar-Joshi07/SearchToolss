...
import Tool47Content from "../assets/defaultToolData.json";

const Tool47 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool47Content[46];
