...
import Tool45Content from "../assets/defaultToolData.json";

const Tool45 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool45Content[44];
