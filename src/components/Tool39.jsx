...
import Tool39Content from "../assets/defaultToolData.json";

const Tool39 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool39Content[38];
