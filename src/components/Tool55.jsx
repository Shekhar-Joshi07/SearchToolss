...
import Tool55Content from "../assets/defaultToolData.json";

const Tool55 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool55Content[54];
