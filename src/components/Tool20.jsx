...
import Tool20Content from "../assets/defaultToolData.json";

const Tool20 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool20Content[19];
