...
import Tool27Content from "../assets/defaultToolData.json";

const Tool27 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool27Content[26];
