...
import Tool19Content from "../assets/defaultToolData.json";

const Tool19 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool19Content[18];
