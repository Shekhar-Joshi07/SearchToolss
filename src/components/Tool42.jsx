...
import Tool42Content from "../assets/defaultToolData.json";

const Tool42 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool42Content[41];
