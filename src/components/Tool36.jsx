...
import Tool36Content from "../assets/defaultToolData.json";

const Tool36 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool36Content[35];
