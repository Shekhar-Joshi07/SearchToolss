...
import Tool34Content from "../assets/defaultToolData.json";

const Tool34 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool34Content[33];
