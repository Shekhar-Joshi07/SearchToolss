...
import Tool37Content from "../assets/defaultToolData.json";

const Tool37 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool37Content[36];
