...
import Tool54Content from "../assets/defaultToolData.json";

const Tool54 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool54Content[53];
