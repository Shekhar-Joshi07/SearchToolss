...
import Tool29Content from "../assets/defaultToolData.json";

const Tool29 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool29Content[28];
