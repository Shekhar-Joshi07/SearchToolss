...
import Tool50Content from "../assets/defaultToolData.json";

const Tool50 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool50Content[49];
