...
import Tool38Content from "../assets/defaultToolData.json";

const Tool38 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool38Content[37];
