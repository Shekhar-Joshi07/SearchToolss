...
import Tool21Content from "../assets/defaultToolData.json";

const Tool21 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool21Content[20];
