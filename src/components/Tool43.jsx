...
import Tool43Content from "../assets/defaultToolData.json";

const Tool43 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool43Content[42];
