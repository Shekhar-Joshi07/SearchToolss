...
import Tool33Content from "../assets/defaultToolData.json";

const Tool33 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool33Content[30];
