...
import Tool25Content from "../assets/defaultToolData.json";

const Tool25 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool25Content[24];
