...
import Tool32Content from "../assets/defaultToolData.json";

const Tool32 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool32Content[31];
