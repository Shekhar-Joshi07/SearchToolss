...
import Tool28Content from "../assets/defaultToolData.json";

const Tool28 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool28Content[27];
