...
import Tool46Content from "../assets/defaultToolData.json";

const Tool46 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool46Content[45];
