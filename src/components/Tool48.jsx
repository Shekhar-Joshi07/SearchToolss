...
import Tool48Content from "../assets/defaultToolData.json";

const Tool48 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool48Content[47];
