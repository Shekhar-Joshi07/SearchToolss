...
import Tool35Content from "../assets/defaultToolData.json";

const Tool35 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool35Content[34];
