...
import Tool51Content from "../assets/defaultToolData.json";

const Tool51 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool51Content[50];
