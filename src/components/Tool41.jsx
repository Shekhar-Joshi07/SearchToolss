...
import Tool41Content from "../assets/defaultToolData.json";

const Tool41 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool41Content[40];
