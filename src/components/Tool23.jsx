...
import Tool23Content from "../assets/defaultToolData.json";

const Tool23 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool23Content[22];
