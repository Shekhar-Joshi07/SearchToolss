...
import Tool44Content from "../assets/defaultToolData.json";

const Tool44 = ({ searchTerm, tNumber, cl, searchMenu }) => {
  const toolContent = Tool44Content[43];
